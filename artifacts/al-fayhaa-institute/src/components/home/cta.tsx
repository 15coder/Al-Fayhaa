    ...
    <section className="py-20 sm:py-24 md:py-28 relative overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 text-center">
        ...
        >
          ...
          <Button size="lg" className="rounded-full h-14 sm:h-16 px-8 sm:px-10 text-base sm:text-lg font-bold bg-white text-primary hover:bg-secondary hover:text-primary-foreground transition-all duration-300 shadow-xl shadow-black/10 hover:scale-105" asChild>
